...
/// <summary>
/// Tower defense editor window.
/// </summary>
public class TD2D : EditorWindow
{
	// Main states
	...
	{
		EditorWindow.GetWindow(typeof(TD2D));
	}
	...
	private void OnSelectionChanged()
	{
		...
		if (Selection.GetFiltered<GameObject>(SelectionMode.ExcludePrefab).Length > 0)
		{
